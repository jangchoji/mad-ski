const FAQS = [
  {
    ...
    answer:
      "MAD INTER SKI SCHOOL은 대명 소노벨 비발디파크에서 성인과 주니어 스키 강습을 진행합니다. 비발디파크 시즌 강습, 단기 강습, 자세교정 상담이 가능합니다.",
  },
  {
    question: "스키를 처음 타는 초보자도 신청할 수 있나요?",
    answer:
      "가능합니다. 비발디파크 초급 스키 강습은 장비 착용, 넘어지고 일어서기, 장비 적응, 스노우플라우 턴부터 시작해 레벨에 맞춰 단계적으로 지도합니다.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "비발디파크 어린이 스키 강습과 주니어 등급제 속성반을 운영합니다. 첫 시즌 등급 취득을 목표로 KSIA 등급 인증서와 뱃지 발급 과정까지 안내합니다.",
  },
];
